...
export default function ReelFitter() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-indigo-500/30 p-6 flex flex-col items-center relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl pt-4 z-10">
        ...
        {/* Back Button */}
        <Link href="/" className="inline-flex items-center gap-2 text-gray-400 hover:text-indigo-400 transition-colors mb-8 group w-fit">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10">
          <div className="inline-flex items-center justify-center p-4 bg-gradient-to-br from-indigo-500/10 to-violet-500/10 border border-indigo-500/20 rounded-2xl mb-6 shadow-[0_0_30px_rgba(99,102,241,0.15)]">
            <Maximize size={36} className="text-indigo-400" />
          </div>
          <h1 className="text-5xl font-extrabold mb-4 tracking-tight">
            Reel <span className="bg-gradient-to-r from-indigo-400 to-violet-500 bg-clip-text text-transparent">Auto-Fitter</span>
          </h1>
          <p className="text-gray-400 text-lg max-w-xl mx-auto">
            Say goodbye to ugly black borders. Turn any photo into a perfect 9:16 (1080x1920) HD format with a cinematic blurred background instantly.
          </p>
        </motion.div>
