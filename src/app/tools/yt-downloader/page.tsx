    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans pb-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 pt-8 md:pt-16">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-black italic tracking-tighter mb-4 uppercase">YT <span className="text-red-500">DOWNLOADER</span></h1>
        </div>
                 ...
                 {showProAlert && (
                    ...
                    >
                       <p className="text-orange-400 font-bold text-sm flex items-center gap-2">
                          <Lock size={16} /> Coming Soon, Have patience
                       </p>
                    </motion.div>
                 )}
              </AnimatePresence>
