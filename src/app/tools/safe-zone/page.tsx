...
export default function SafeZoneOverlay() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-rose-500/30 p-6 flex flex-col items-center relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl pt-4 z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
          <Link href="/" className="inline-flex items-center gap-2 text-gray-400 hover:text-rose-400 transition-colors group">
          ...
          <div className="flex items-center gap-3 bg-white/5 px-6 py-3 rounded-full border border-white/10 backdrop-blur-md">
            ...
            <h1 className="text-xl font-bold">Safe Zone Previewer</h1>
          </div>
        </div>
