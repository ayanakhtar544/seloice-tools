...
export default async function ToolsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="page-shell min-h-dvh bg-[#050505] text-white selection:bg-indigo-500/30 overflow-x-hidden flex flex-col">
      {/* FLOATING BACKGROUND EFFECTS (consistent with main page) */}
      <div className="fixed inset-0 z-0 pointer-events-none flex justify-center">
        <div className="background-orb absolute top-[-20%] left-[-10%] w-[60rem] h-[60rem] bg-indigo-600/10 rounded-full blur-[150px] opacity-70 mix-blend-screen" />
        <div className="background-orb absolute bottom-[-10%] right-[-10%] w-[50rem] h-[50rem] bg-pink-600/10 rounded-full blur-[150px] opacity-70 mix-blend-screen" />
        <div
      ...
      <main id="tools-main" className="flex-grow pt-20 md:pt-32 pb-24 md:pb-20 relative z-10 px-3 sm:px-4 md:px-6 w-full max-w-[1440px] mx-auto">
