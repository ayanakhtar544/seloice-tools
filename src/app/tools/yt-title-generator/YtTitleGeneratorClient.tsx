...
export default function YtTitleGeneratorClient() {
    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans pb-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 pt-8 md:pt-16">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-6xl font-black italic tracking-tighter mb-4 uppercase">TITLE <span className="text-red-500">GENERATOR</span></h2>
